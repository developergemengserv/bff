...
//CommonController
    ...
    public ResponseEntity<Object> getSafetyDashboardCounts(@RequestHeader("user_id") int user_id,
        ...
        return raymondAdminService.getSafetyDashboardCounts(user_id, token, projectId);
    }
    ...
    public ResponseEntity<Map<String, Object>> getAllLocationsFromDB(
        ...
        return raymondAdminService.getAllLocationsFromDB(pid, page, pageSize, request, user_id, token);
    }
