...
public class TEJRAJ_QHSE_BFF_Controller
{
    ...
    @Autowired
    TEJRAJ_QHSE_8081 tejraj_qhse_8081_service;
...
//    ActivityMasterController
    ...
    {
        return tejraj_qhse_8081_service.getActivitiesByUser(userId, projectId, token, pageSize, page, lastSync);
    }
    ...
    {
        return tejraj_qhse_8081_service.getChecklists(page, pageSize, user_id, project_id, token, lastSync);
    }

    @GetMapping(value = "/getActivities")
    public ResponseEntity<List<Object>> getActivities()
    {
        return tejraj_qhse_8081_service.getActivities();
    }
    ...
    {
        return tejraj_qhse_8081_service.addActivities(file,userId);
    }
    ...
    {
        return tejraj_qhse_8081_service.addLocations(userId,file);
    }
...
//    ActivityTypeOfWorkMappingController
    ...
    {
        return tejraj_qhse_8081_service.getActivityTypeOfWorkMapping(userId, token, lastSync);
    }
...
//   ActivityUnitMappingController
    ...
    {
        return tejraj_qhse_8081_service.getAllActivityUnitMapping();
    }
    ...
    public ResponseEntity<Object> getConfiguration(@RequestParam("package_id") String package_id) {
        return tejraj_qhse_8081_service.getConfiguration(package_id);
    }
    ...
    public ResponseEntity<Map<String, Object>> checkotp(@RequestParam("otp") int otp, @RequestParam("user_id") int user_id, @RequestParam("version") String version,
        ...
        return tejraj_qhse_8081_service.checkotp(otp, user_id, version, device_code);
    }
    ...
    public ResponseEntity<Map<String, Object>> logout(@RequestParam("user_id") int user_id, @RequestParam("version") String version,
                                                      @RequestParam("device_code") String device_code) {
        return tejraj_qhse_8081_service.logout(user_id, version, device_code);
    }
    ...
    public ResponseEntity<?> userDetails(@RequestParam("user_id") int user_id,
                                         @RequestParam("token") String token)
    {
        return tejraj_qhse_8081_service.userDetails(user_id, token);
    }
    ...
    {
        return tejraj_qhse_8081_service.addCompany(userId,token,companyCreateRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.updateCompany(userId,token,companyUpdateRequest);
    }

    @GetMapping("/company")
    public Object getCombinedResponse(@RequestParam("userId") int userId,
                                      @RequestParam("token") String token) {
        return tejraj_qhse_8081_service.getCompanies(userId, token);
    }
    ...
    {
        return tejraj_qhse_8081_service.deleteCompany(companyId);
    }

    @GetMapping("/registerUser")
    public Object registerUser(@RequestBody Object userRegisterRequest) {
        return tejraj_qhse_8081_service.registerUser(userRegisterRequest);
    }
    ...
    public ResponseEntity<?> loginV2(@RequestParam("username") String username, @RequestParam("password") String password) {
        return tejraj_qhse_8081_service.loginAPI(username, password);
    }
    ...
    {
        return tejraj_qhse_8081_service.login(username, password);
    }
    ...
    public void doDownload(@RequestParam("media_url") String mediaUrl, @RequestParam("user_id") int user_id, @RequestParam("token") String token, HttpServletResponse response)
            throws IOException
    {
        tejraj_qhse_8081_service.doDownload(mediaUrl,user_id,token,response);
    }
    ...
    public ResponseEntity<Object> uploadSignature(@RequestHeader(value = "userId") Integer userId,
                                                  ...
                                                  @RequestParam(value = "file") MultipartFile file)
    {
        return tejraj_qhse_8081_service.uploadSignature(userId,token,file);
    }
    ...
    {
        return tejraj_qhse_8081_service.createQcNcr(userId, token,ncrRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.getNcr(userId, token,companyId,projectId,pageNum,pageSize);
    }
    ...
    {
        return tejraj_qhse_8081_service.getNcrDetails(userId, token,ncrId);
    }
    ...
    {
        return tejraj_qhse_8081_service.saveSafetyTBT(userId,token,safetyTBTRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.getSafetyTBT(userId,token,projectId);
    }
    ...
    {
        return tejraj_qhse_8081_service.getSafetyTbtById(userId,token,tbtId);
    }
    ...
    public ResponseEntity<Object> createSafetyObservation(
        ...
        return tejraj_qhse_8081_service.createSafetyObservation(userId, token, obsRequest);
    }
    ...
    public ResponseEntity<Object> updateSafetyObservation(
        ...
        return tejraj_qhse_8081_service.updateSafetyObservation(userId, token, updateRequest);
    }
    ...
    public ResponseEntity<Object> findSafetyObservation(
        ...
        return tejraj_qhse_8081_service.findSafetyObservation(userId, token, lastSync, findRequest);
    }
    ...
    public ResponseEntity<Object> findSafetyObservationByObsId(
        ...
        return tejraj_qhse_8081_service.findSafetyObservationByObsId(userId, token, obsId);
    }
    ...
    public ResponseEntity<Object> findObservationRequestHistory(
        ...
        return tejraj_qhse_8081_service.findObservationRequestHistory(userId, token, historyRequest);
    }
    ...
    public ResponseEntity<Object> findAllUnsafeAct(
            ...
            @RequestHeader(value = "token") String token,
            @RequestParam(value = "lastSync", required = false) String lastSync) {
        return tejraj_qhse_8081_service.findAllUnsafeAct(userId, token, lastSync);
    }
    ...
    public ResponseEntity<Object> findAllUnsafeCondition(
            ...
            @RequestHeader(value = "token") String token,
            @RequestParam(value = "lastSync", required = false) String lastSync) {
        return tejraj_qhse_8081_service.findAllUnsafeCondition(userId, token, lastSync);
    }
    ...
    public ResponseEntity<Object> findAllTypeOfWork(
            ...
            @RequestHeader(value = "token") String token,
            @RequestParam(value = "lastSync", required = false) String lastSync) {
        return tejraj_qhse_8081_service.findAllTypeOfWork(userId, token, lastSync);
    }
    ...
    public ResponseEntity<Object> findAllChecklistQuestions(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync)
    {
        return tejraj_qhse_8081_service.findAllChecklistQuestions(userId, token, lastSync);
    }
    ...
    public ResponseEntity<Object> findAllTypeOfWorkChecklistMapping(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync)
    {
        return tejraj_qhse_8081_service.findAllTypeOfWorkChecklistMapping(userId, token, lastSync);
    }

    @RequestMapping(value = "/rest/v1/getRoleMaster", method = RequestMethod.GET)
    ResponseEntity<Object> getRoleMaster()
    {
        return tejraj_qhse_8081_service.getRoleMaster();
    }
    ...
    public ResponseEntity<Object> createSafetyPTW(
        ...
        return tejraj_qhse_8081_service.createSafetyPTW(userId, token, ptwRequest);
    }
    ...
    public ResponseEntity<Object> updateSafetyPTW(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object ptwRequest) {
        return tejraj_qhse_8081_service.updateSafetyPTW(userId, token, ptwRequest);
    }
    ...
    public ResponseEntity<Object> updatePTWStatus(
        ...
        return tejraj_qhse_8081_service.updatePTWStatus(userId, token, request);
    }

    @PutMapping(value = "/safety/ptwClose")
    public ResponseEntity<Object> updateUnclosedPTW() {
        return tejraj_qhse_8081_service.updateUnclosedPTW();
    }
    ...
    public ResponseEntity<Object> findSafetyPTW(
        ...
        return tejraj_qhse_8081_service.findSafetyPTW(userId, token, page, pageSize, projectId, lastSync, locationLevel1Id);
    }
    ...
    public ResponseEntity<Object> findSafetyPTWSP(
            ...
            @RequestParam(value = "page_size", defaultValue = "500") Integer pageSize,
            @RequestParam(value = "project_id") Integer projectId) {
        return tejraj_qhse_8081_service.findSafetyPTWSP(userId, token, page, pageSize, projectId);
    }
    ...
    public ResponseEntity<Object> findSafetyPTWW(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync,
            @RequestParam(value = "locationLevel1Id", required = false) Integer locationLevel1Id) {
        return tejraj_qhse_8081_service.findSafetyPTWW(userId, token, page, pageSize, projectId, lastSync, locationLevel1Id);
    }
    ...
    public ResponseEntity<Object> findSafetyPTWById(
        ...
        return tejraj_qhse_8081_service.findSafetyPTWById(userId, token, ptwId);
    }
    ...
    public ResponseEntity<Object> findPTWById(
            ...
            @RequestHeader(value = "token") String token,
            @PathVariable(value = "ptwId") Integer ptwId) {
        return tejraj_qhse_8081_service.findPTWById(userId, token, ptwId);
    }
    ...
    public ResponseEntity<Object> findPTWByFilter(
            ...
            @RequestHeader(value = "userId") Integer userId,
            @RequestHeader(value = "token") String token) {
        return tejraj_qhse_8081_service.findPTWByFilter(fromDate, toDate, userId, token);
    }
    ...
    public ResponseEntity<Object> findPTWHistory(
        ...
        return tejraj_qhse_8081_service.findPTWHistory(userId, token, ptwHistoryFindRequest);
    }
    ...
    public ResponseEntity<Object> findPtwCount(
        ...
        return tejraj_qhse_8081_service.findPtwCount(userId, token, dashboardCountRequest);
    }
    ...
    public ResponseEntity<Object> findObsCount(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object dashboardCountRequest) {
        return tejraj_qhse_8081_service.findObsCount(userId, token, dashboardCountRequest);
    }
    ...
    public ResponseEntity<Object> findEcCount(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object dashboardCountRequest) {
        return tejraj_qhse_8081_service.findEcCount(userId, token, dashboardCountRequest);
    }
    ...
    public ResponseEntity<Object> findTbtCount(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object dashboardCountRequest) {
        return tejraj_qhse_8081_service.findTbtCount(userId, token, dashboardCountRequest);
    }
    ...
    public ResponseEntity<Object> uploadMultipleFiles(
        ...
        return tejraj_qhse_8081_service.uploadMultipleFiles(userId, token, eventId, eventName, files);
    }
    ...
    public ResponseEntity<Object> uploadCheckListMedia(
            ...
            @RequestPart("file") MultipartFile[] files) {
        return tejraj_qhse_8081_service.uploadCheckListMedia(userId, token, checklistAnswerId, files);
    }
    ...
    public ResponseEntity<Object> findUsersByProjectIdAndRoleId(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync) {
        return tejraj_qhse_8081_service.findUsersByProjectIdAndRoleId(userId, token, projectId, roleId, lastSync);
    }
    ...
    public ResponseEntity<Object> sendOBSNotification(
        ...
        return tejraj_qhse_8081_service.sendOBSNotification(level1LocationId, obsId, userId);
    }
    ...
    // Equipment
        ...
        public ResponseEntity<Object> saveEquipment(
            ...
            return tejraj_qhse_8081_service.saveEquipment(userId, token, equipmentRequest);
        }
        ...
        public ResponseEntity<Object> updateEquipment(
                ...
                @RequestHeader(value = "token") String token,
                @RequestBody Object equipmentRequest) {
            return tejraj_qhse_8081_service.updateEquipment(userId, token, equipmentRequest);
        }
        ...
        public ResponseEntity<Object> findSafetyEquipment(
                ...
                @RequestParam(value = "lastSync", required = false) String lastSync,
                @RequestParam(value = "locationLevel1Id", required = false) Integer locationLevel1Id) {
            return tejraj_qhse_8081_service.findSafetyEquipment(userId, token, page, pageSize, projectId, lastSync, locationLevel1Id);
        }
        ...
        public ResponseEntity<Object> findEQHistory(
            ...
            return tejraj_qhse_8081_service.findEQHistory(userId, token, eqHistoryFindRequest);
        }
        ...
        public ResponseEntity<Object> findSafetyEquipmentById(
            ...
            return tejraj_qhse_8081_service.findSafetyEquipmentById(userId, token, equipmentId);
        }
        ...
        public ResponseEntity<Object> findOBSByFilter(
                ...
                @RequestHeader(value = "token") String token) {
            return tejraj_qhse_8081_service.findOBSByFilter(fromDate, toDate, userId, token);
        }
        ...
        public ResponseEntity<Object> findSafetyStatistics(
            ...
            return tejraj_qhse_8081_service.findSafetyStatistics(userId, token, projectId);
        }
        ...
        public ResponseEntity<Object> sendBulletin(
            ...
            return tejraj_qhse_8081_service.sendBulletin(userId, token, bulletinRequest);
        }
        ...
        public ResponseEntity<Object> findBulletinByProjectId(
                ...
                @RequestHeader(value = "token") String token,
                @PathVariable(value = "projectId") Integer projectId) {
            return tejraj_qhse_8081_service.findBulletinByProjectId(userId, token, projectId);
        }
        ...
        public ResponseEntity<Object> getSafetyDigitalLibrary(
            ...
            return tejraj_qhse_8081_service.getSafetyDigitalLibrary(userId, token, projectId);
        }
        ...
        public ResponseEntity<Object> getPendingPtw(
                ...
                @RequestHeader(value = "token") String token,
                @RequestParam(value = "projectId") int projectId) {
            return tejraj_qhse_8081_service.getPendingPtw(userId, token, projectId);
        }
    ...
    public ResponseEntity<Object> findCompanyUsers(
            @RequestHeader(value = "userId") Integer userId,
            @RequestHeader(value = "token") String token) {
        return tejraj_qhse_8081_service.findCompanyUsers(userId, token);
    }
    ...
    public ResponseEntity<Object> getDataForObsReport(
        ...
        return tejraj_qhse_8081_service.getDataForObsReport(userId, token, obsId, webCall);
    }
    ...
    {
        return tejraj_qhse_8081_service.addEmergencyHelpLine(userId,token,emergencyHelplineRequest);
    }
    ...
    public ResponseEntity<List<Object>> getAllEmergencyHelpLine(@RequestHeader(value = "userId") Integer userId,
                                                                ...
                                                                int projectId)
    {
        return tejraj_qhse_8081_service.getAllEmergencyHelpLine(userId,token,projectId);
    }
    ...
    public ResponseEntity<Object> updateEmergencyHelpLine(@RequestHeader(value = "userId") Integer userId,
                                                          ...
                                                          @RequestBody Object emergencyHelplineRequest)
    {
        return tejraj_qhse_8081_service.updateEmergencyHelpLine(userId,token,emergencyHelplineRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.deleteEmergencyHelpLine(userId,token,id);
    }
    ...
    public ResponseEntity<Object> uploadHazards(@RequestHeader(value = "userId") Integer userId,
                                                               ...
                                                               @RequestParam(value = "file") MultipartFile file)
    {
        return tejraj_qhse_8081_service.uploadHazards(userId,token,projectId,file);
    }
    ...
    {
        return tejraj_qhse_8081_service.getHazardsByProjectId(userId,token,projectId);
    }
    ...
    public ResponseEntity<Map<String, Object>> findLocation(@RequestBody String data,
                                                            @RequestParam(value = "lastSync", required = false) String lastSync)
    {
        return tejraj_qhse_8081_service.findLocation(data,lastSync);
    }
    ...
    public ResponseEntity<Map<String, Object>> getAllLocationsFromDB(
            ...
            @RequestParam("token") String token)
    {
        return tejraj_qhse_8081_service.getAllLocationsFromDB(pid,page,pageSize,request,user_id,token);
    }
    ...
    {
        return tejraj_qhse_8081_service.getLocationLevel1ByProjectId(projectId);
    }
    ...
    public String addLocations(@RequestParam(value = "userId") int userId,
                               ...
                               @RequestParam(value = "projectId") int projectId)
    {
        return tejraj_qhse_8081_service.addLocations(userId,file,projectId);
    }
    ...
    public Map<String, Integer> checklistDataUpload(
            ...
            @RequestParam(value = "userId") int userId)
    {
        return tejraj_qhse_8081_service.checklistDataUpload(file,userId);
    }
    ...
    public ResponseEntity<Object> getAllObservationsFromDB(@RequestParam(value = "page_num", defaultValue = "1", required = false) int page,
                                                           ...
                                                           @RequestParam(value = "lastSync", required = false) String lastSync)
    {
        return tejraj_qhse_8081_service.getAllObservationsFromDB(page,pageSize,request,userId,token,lastSync);
    }
    ...
    {
        return tejraj_qhse_8081_service.saveProgressReport(userId,token,progressReportRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.getProgressReport(userId,token);
    }
    ...
    {
        return tejraj_qhse_8081_service.getProgressReportById(userId,token,progressReportId);
    }
    ...
    {
        return tejraj_qhse_8081_service.restProjects(user_id,token,lastSync);
    }
    ...
    {
        return tejraj_qhse_8081_service.addProject(userId,token,projectCreateRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.updateProject(userId,token,projectUpdateRequest);
    }
    ...
    public List<Object> getProjects(@RequestHeader("userId") int userId,
                                    @RequestHeader("token") String token)
    {
        return tejraj_qhse_8081_service.getProjects(userId,token);
    }
    ...
    {
        return tejraj_qhse_8081_service.createCRFI(userId,token,activityInspectionRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.updateCRFI(userId,token,activityInspectionUpdateRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.getCRFI(userId,token,crfiId,projectId);
    }
    ...
    public ResponseEntity<Object> getCRFIDetails(@RequestHeader(value = "userId") int userId,
                                                 ...
                                                 @RequestParam(value = "crfiId") long crfiId)
    {
        return tejraj_qhse_8081_service.getCRFIDetails(userId,token,crfiId);
    }
    ...
    {
        return tejraj_qhse_8081_service.getDataForRFIReport(userId,token,crfiId,webCall);
    }
    ...
    {
        return tejraj_qhse_8081_service.getObsFilter(userId,token,filterCrfiRequest);
    }
    ...
    public ResponseEntity<Object> createQCObservation(@RequestHeader(value = "userId") Integer userId,
                                                      ...
                                                      @RequestBody Object obsRequest)
    {
        return tejraj_qhse_8081_service.createQCObservation(userId,token,obsRequest);
    }
    ...
    public ResponseEntity<List<Object>> getObs(@RequestHeader(value = "userId") int userId,
                                               ...
                                               @RequestParam(value = "projectId") long projectId)
    {
        return tejraj_qhse_8081_service.getObs(userId,token,obsId,projectId);
    }
    ...
    {
        return tejraj_qhse_8081_service.updateOBS(userId,token,obsUpdateRequest);
    }
    ...
    public ResponseEntity<Object> getOBSDetails(@RequestHeader(value = "userId") int userId,
                                                ...
                                                @RequestParam(value = "obsId") long obsId)
    {
        return tejraj_qhse_8081_service.getOBSDetails(userId,token,obsId);
    }
    ...
    {
       return tejraj_qhse_8081_service.ptwReportDownload(userId,token,ptwId,webCall);
    }
    ...
    {
        return tejraj_qhse_8081_service.safetyObsReportByFilter(fromDate,toDate,userId,projectId);
    }
    ...
    {
        return tejraj_qhse_8081_service.downloadMemoPdf(user_id,token,obsId);
    }
    ...
    {
        return tejraj_qhse_8081_service.downloadDebitPdf(user_id,token,debitId);
    }
    ...
    {
      return tejraj_qhse_8081_service.downloadIncidentPdf(user_id,token,incidentId);
    }
    ...
    public ResponseEntity<Object> sendIncidentPdf(@RequestHeader("user_id") int user_id,
                                                  ...
                                                  @RequestParam(name = "incidentId", required = false, defaultValue = "0") int incidentId)
    {
      return tejraj_qhse_8081_service.sendIncidentPdf(user_id,token,incidentId);
    }
    ...
    {
       return tejraj_qhse_8081_service.downloadTBTPdf(user_id,token,tbtId);
    }
    ...
    {
        return tejraj_qhse_8081_service.equipmentReport(equipmentReportRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.getObsReport(userId,token,obsId);
    }
    ...
    {
        tejraj_qhse_8081_service.weeklyStatusReport(projectId,fromDate,toDate,locationBased);
    }
    ...
    public ResponseEntity<Object> downloadWorkerPdf(@RequestParam("user_id") int user_id,
                                                    ...
                                                    @RequestParam(value = "webCall", defaultValue = "true", required = false) boolean webCall)
    {
       return tejraj_qhse_8081_service.downloadWorkerPdf(user_id,token,workerId,webCall);
    }
    ...
    public ResponseEntity<Object> saveIncident(@RequestHeader(value = "userId") Integer userId,
                                               ...
                                               @RequestBody Object request)
    {
        return tejraj_qhse_8081_service.saveIncident(userId,token,request);
    }
    ...
    public ResponseEntity<Object> findSafetyIncident(@RequestHeader(value = "userId") Integer userId,
                                                     ...
                                                     @RequestParam(value = "project_id") Integer projectId)
    {
        return tejraj_qhse_8081_service.findSafetyIncident(userId,token,page,pageSize,projectId);
    }
    ...
    {
        return tejraj_qhse_8081_service.findIncidentById(userId,token,incidentId);
    }
    ...
    {
        return tejraj_qhse_8081_service.saveSafetyWorkers(userId,token,safetyWorkersRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.getSafetyWorkers(userId,token,projectId);
    }
    ...
    {
        return tejraj_qhse_8081_service.getSafetyWorkersById(userId,token,workerId);
    }
    ...
    public ResponseEntity<Object> updateSafetyWorkerById(@RequestHeader(value = "user_id") int userId,
                                                         ...
                                                         @RequestBody Object request)
    {
        return tejraj_qhse_8081_service.updateSafetyWorkerById(userId,token,workerId,request);
    }
    ...
    public ResponseEntity<List<Object>> getAllUnitMaster(@RequestHeader(value = "userId") Integer userId,
                                                         @RequestHeader(value = "token") String token)
    {
        return tejraj_qhse_8081_service.getAllUnitMaster(userId,token);
    }
    ...
    {
        return tejraj_qhse_8081_service.getUnitMasterById(userId,token,unitMasterId);
    }
    ...
    {
        return tejraj_qhse_8081_service.addUser(userId,token,userRequestModel);
    }
    ...
    public ResponseEntity<Object> UpdateUser(@RequestHeader(value = "userId") Integer userId,
                                             ...
                                             @RequestBody Object userRequestModel)
    {
        return tejraj_qhse_8081_service.UpdateUser(userId,token,userRequestModel);
    }
    ...
    {
        return tejraj_qhse_8081_service.getUsers(userId,token,projectId,companyId,pageNum,pageSize);
    }
    ...
    {
        return tejraj_qhse_8081_service.getNonProjectUsers(projectId,companyId);
    }
    ...
    {
        return tejraj_qhse_8081_service.userMapping(userMappingRequest);
    }
    ...
    {
        return tejraj_qhse_8081_service.deleteUser(userId);
    }
