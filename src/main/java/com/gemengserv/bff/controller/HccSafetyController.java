...
// Observation Master Controller
    ...
    {
        return hccSafetyService.getRoasterObs(userId, token, roasterId);
    }
    ...
    public ResponseEntity<List<Object>> getSubtypes(@RequestHeader(value = "userId") Integer userId, @RequestHeader(value = "token") String token) {
        return hccSafetyService.getSubtypes(userId, token);
    }
}
