...
public class AshwinShethAdminController {
    ...
    public ResponseEntity<Object> getSafetyDashboardCounts(@RequestHeader("user_id") int user_id,
        ...
        return ashwinShethAdminService.getSafetyDashboardCounts(user_id, token, projectId);
    }
    ...
    public ResponseEntity<Map<String, Object>> getAllLocationsFromDB(
        ...
        return ashwinShethAdminService.getAllLocationsFromDB(pid, page, pageSize, request, user_id, token);
    }
