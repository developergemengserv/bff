...
public class AshwinshethQhseController {
    ...
    @Autowired
    AshwinshethQhseService ashwinshethQhseService;
...
//    ActivityMasterController
    ...
    {
        return ashwinshethQhseService.getActivitiesByUser(userId, projectId, token, pageSize, page, lastSync);
    }
    ...
    {
        return ashwinshethQhseService.getChecklists(page, pageSize, user_id, project_id, token, lastSync);
    }

    @GetMapping(value = "/getActivities")
    public ResponseEntity<List<Object>> getActivities()
    {
        return ashwinshethQhseService.getActivities();
    }
    ...
    {
        return ashwinshethQhseService.addActivities(file,userId);
    }
    ...
    {
        return ashwinshethQhseService.addLocations(userId,file);
    }
    ...
    {
        return ashwinshethQhseService.addActivity(userId, token, activityRequest);
    }
    ...
    public ResponseEntity<Object> editActivity(@RequestHeader(value = "userId") Integer userId,
                                               ...
                                               @RequestBody Object activityRequest)
    {
        return ashwinshethQhseService.editActivity(userId, token, activityRequest);
    }
    ...
    {
        return ashwinshethQhseService.getActivityTypeOfWorkMapping(userId, token, lastSync);
    }
    ...
    {
        return ashwinshethQhseService.getAllActivityUnitMapping();
    }
    ...
    public ResponseEntity<Object> getConfiguration(@RequestParam("package_id") String package_id) {
        return ashwinshethQhseService.getConfiguration(package_id);
    }
    ...
    public ResponseEntity<Map<String, Object>> checkotp(@RequestParam("otp") int otp, @RequestParam("user_id") int user_id, @RequestParam("version") String version,
        ...
        return ashwinshethQhseService.checkotp(otp, user_id, version, device_code);
    }
    ...
    public ResponseEntity<Map<String, Object>> logout(@RequestParam("user_id") int user_id, @RequestParam("version") String version,
                                                      @RequestParam("device_code") String device_code) {
        return ashwinshethQhseService.logout(user_id, version, device_code);
    }
    ...
    public ResponseEntity<Object> userDetails(@RequestParam("user_id") int user_id,
                                              @RequestParam("token") String token)
    {
        return ashwinshethQhseService.userDetails(user_id, token);
    }
    ...
    {
        return ashwinshethQhseService.addCompany(userId,token,companyCreateRequest);
    }
    ...
    {
        return ashwinshethQhseService.updateCompany(userId,token,companyUpdateRequest);
    }
    ...
    public List<Object> getCompaniesProjectWise(@RequestHeader("userId") int userId,
                                                @RequestHeader("token") String token)
    {
        return ashwinshethQhseService.getCompaniesProjectWise(userId, token);
    }

    @RequestMapping(value = "/company", method = RequestMethod.GET)
    public List<Object> getCompanies(@RequestHeader("userId") int userId,
                                     @RequestHeader("token") String token) {
        return ashwinshethQhseService.getCompanies(userId, token);
    }
    ...
    {
        return ashwinshethQhseService.deleteCompany(companyId);
    }
    ...
    {
        return ashwinshethQhseService.downloadCompaniesExcel(userId, token, pageNum, pageSize);
    }

    @GetMapping("/registerUser")
    public Object registerUser(@RequestBody Object userRegisterRequest) {
        return ashwinshethQhseService.registerUser(userRegisterRequest);
    }
    ...
    public ResponseEntity<Object> loginV2(@RequestParam("username") String username, @RequestParam("password") String password) {
        return ashwinshethQhseService.loginAPI(username, password);
    }
    ...
    {
        return ashwinshethQhseService.login(username, password);
    }
    ...
    public void doDownload(@RequestParam("media_url") String mediaUrl, @RequestParam("user_id") int user_id, @RequestParam("token") String token, HttpServletResponse response)
            throws IOException
    {
        ashwinshethQhseService.doDownload(mediaUrl,user_id,token,response);
    }
    ...
    public ResponseEntity<Object> uploadSignature(@RequestHeader(value = "userId") Integer userId,
                                                  ...
                                                  @RequestParam(value = "file") MultipartFile file)
    {
        return ashwinshethQhseService.uploadSignature(userId,token,file);
    }
    ...
    {
        return ashwinshethQhseService.createQcNcr(userId, token,ncrRequest);
    }
    ...
    {
        return ashwinshethQhseService.getNcr(userId, token,companyId,projectId,pageNum,pageSize);
    }
    ...
    {
        return ashwinshethQhseService.getNcrDetails(userId, token,ncrId);
    }
    ...
    {
        return ashwinshethQhseService.updateNcr(userId, token, qcNcrUpdateRequest);
    }
    ...
    {
        return ashwinshethQhseService.getNcrFilter(userId, token, ncrFilterRequest);
    }
    ...
    {
        return ashwinshethQhseService.getDataForNcrReport(userId, token, ncrId, webCall);
    }
    ...
    {
        return ashwinshethQhseService.saveSafetyTBT(userId,token,safetyTBTRequest);
    }
    ...
    {
        return ashwinshethQhseService.getSafetyTBT(userId,token,projectId);
    }
    ...
    {
        return ashwinshethQhseService.getSafetyTbtById(userId,token,tbtId);
    }
    ...
    public ResponseEntity<Object> createSafetyObservation(
        ...
        return ashwinshethQhseService.createSafetyObservation(userId, token, obsRequest);
    }
    ...
    public ResponseEntity<Object> updateSafetyObservation(
        ...
        return ashwinshethQhseService.updateSafetyObservation(userId, token, updateRequest);
    }
    ...
    public ResponseEntity<Object> findSafetyObservation(
        ...
        return ashwinshethQhseService.findSafetyObservation(userId, token, lastSync, findRequest);
    }
    ...
    public ResponseEntity<Object> findSafetyObservationByObsId(
        ...
        return ashwinshethQhseService.findSafetyObservationByObsId(userId, token, obsId);
    }
    ...
    public ResponseEntity<Object> findObservationRequestHistory(
        ...
        return ashwinshethQhseService.findObservationRequestHistory(userId, token, historyRequest);
    }
    ...
    public ResponseEntity<Object> findAllUnsafeAct(
            ...
            @RequestHeader(value = "token") String token,
            @RequestParam(value = "lastSync", required = false) String lastSync) {
        return ashwinshethQhseService.findAllUnsafeAct(userId, token, lastSync);
    }
    ...
    public ResponseEntity<Object> findAllUnsafeCondition(
            ...
            @RequestHeader(value = "token") String token,
            @RequestParam(value = "lastSync", required = false) String lastSync) {
        return ashwinshethQhseService.findAllUnsafeCondition(userId, token, lastSync);
    }
    ...
    public ResponseEntity<Map<String, Object>> findAllTypeOfWork(
            ...
            @RequestParam(value = "token") String token,
            @RequestParam(value = "lastSync", required = false) String lastSync) {
        return ashwinshethQhseService.findAllTypeOfWork(userId, token, lastSync);
    }
    ...
    public ResponseEntity<Object> findAllChecklistQuestions(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync)
    {
        return ashwinshethQhseService.findAllChecklistQuestions(userId, token, lastSync);
    }
    ...
    public ResponseEntity<Object> findAllTypeOfWorkChecklistMapping(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync)
    {
        return ashwinshethQhseService.findAllTypeOfWorkChecklistMapping(userId, token, lastSync);
    }

    @RequestMapping(value = "/rest/v1/getRoleMaster", method = RequestMethod.GET)
    ResponseEntity<Object> getRoleMaster()
    {
        return ashwinshethQhseService.getRoleMaster();
    }
    ...
    public ResponseEntity<Object> createSafetyPTW(
        ...
        return ashwinshethQhseService.createSafetyPTW(userId, token, ptwRequest);
    }
    ...
    public ResponseEntity<Object> updateSafetyPTW(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object ptwRequest) {
        return ashwinshethQhseService.updateSafetyPTW(userId, token, ptwRequest);
    }
    ...
    public ResponseEntity<Object> updatePTWStatus(
        ...
        return ashwinshethQhseService.updatePTWStatus(userId, token, request);
    }

    @PutMapping(value = "/safety/ptwClose")
    public ResponseEntity<Object> updateUnclosedPTW() {
        return ashwinshethQhseService.updateUnclosedPTW();
    }
    ...
    public ResponseEntity<Object> findSafetyPTW(
        ...
        return ashwinshethQhseService.findSafetyPTW(userId, token, page, pageSize, projectId, lastSync, locationLevel1Id);
    }
    ...
    public ResponseEntity<Object> findSafetyPTWSP(
            ...
            @RequestParam(value = "page_size", defaultValue = "500") Integer pageSize,
            @RequestParam(value = "project_id") Integer projectId) {
        return ashwinshethQhseService.findSafetyPTWSP(userId, token, page, pageSize, projectId);
    }
    ...
    public ResponseEntity<Object> findSafetyPTWW(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync,
            @RequestParam(value = "locationLevel1Id", required = false) Integer locationLevel1Id) {
        return ashwinshethQhseService.findSafetyPTWW(userId, token, page, pageSize, projectId, lastSync, locationLevel1Id);
    }
    ...
    public ResponseEntity<Object> findSafetyPTWById(
        ...
        return ashwinshethQhseService.findSafetyPTWById(userId, token, ptwId);
    }
    ...
    public ResponseEntity<Object> findPTWById(
            ...
            @RequestHeader(value = "token") String token,
            @PathVariable(value = "ptwId") Integer ptwId) {
        return ashwinshethQhseService.findPTWById(userId, token, ptwId);
    }
    ...
    public ResponseEntity<Object> findPTWByFilter(
            ...
            @RequestHeader(value = "userId") Integer userId,
            @RequestHeader(value = "token") String token) {
        return ashwinshethQhseService.findPTWByFilter(fromDate, toDate, userId, token);
    }
    ...
    public ResponseEntity<Object> findPTWHistory(
        ...
        return ashwinshethQhseService.findPTWHistory(userId, token, ptwHistoryFindRequest);
    }
    ...
    public ResponseEntity<Object> findPtwCount(
        ...
        return ashwinshethQhseService.findPtwCount(userId, token, dashboardCountRequest);
    }
    ...
    public ResponseEntity<Object> findObsCount(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object dashboardCountRequest) {
        return ashwinshethQhseService.findObsCount(userId, token, dashboardCountRequest);
    }
    ...
    public ResponseEntity<Object> findEcCount(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object dashboardCountRequest) {
        return ashwinshethQhseService.findEcCount(userId, token, dashboardCountRequest);
    }
    ...
    public ResponseEntity<Object> findTbtCount(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object dashboardCountRequest) {
        return ashwinshethQhseService.findTbtCount(userId, token, dashboardCountRequest);
    }
    ...
    public ResponseEntity<Object> uploadMultipleFiles(
        ...
        return ashwinshethQhseService.uploadMultipleFiles(userId, token, eventId, eventName, files);
    }
    ...
    public ResponseEntity<Object> uploadCheckListMedia(
            ...
            @RequestPart("file") MultipartFile[] files) {
        return ashwinshethQhseService.uploadCheckListMedia(userId, token, checklistAnswerId, files);
    }
    ...
    public ResponseEntity<Object> findUsersByProjectIdAndRoleId(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync) {
        return ashwinshethQhseService.findUsersByProjectIdAndRoleId(userId, token, projectId, roleId, lastSync);
    }
    ...
    public ResponseEntity<Object> sendOBSNotification(
        ...
        return ashwinshethQhseService.sendOBSNotification(level1LocationId, obsId, userId);
    }
...
//    }
    ...
    public ResponseEntity<Object> saveEquipment(
        ...
        return ashwinshethQhseService.saveEquipment(userId, token, equipmentRequest);
    }
    ...
    public ResponseEntity<Object> updateEquipment(
            ...
            @RequestHeader(value = "token") String token,
            @RequestBody Object equipmentRequest) {
        return ashwinshethQhseService.updateEquipment(userId, token, equipmentRequest);
    }
    ...
    public ResponseEntity<Object> findSafetyEquipment(
            ...
            @RequestParam(value = "lastSync", required = false) String lastSync,
            @RequestParam(value = "locationLevel1Id", required = false) Integer locationLevel1Id) {
        return ashwinshethQhseService.findSafetyEquipment(userId, token, page, pageSize, projectId, lastSync, locationLevel1Id);
    }
    ...
    public ResponseEntity<Object> findEQHistory(
        ...
        return ashwinshethQhseService.findEQHistory(userId, token, eqHistoryFindRequest);
    }
    ...
    public ResponseEntity<Object> findSafetyEquipmentById(
        ...
        return ashwinshethQhseService.findSafetyEquipmentById(userId, token, equipmentId);
    }
    ...
    public ResponseEntity<Object> findOBSByFilter(
            ...
            @RequestParam(value = "userId") Integer userId,
            @RequestHeader(value = "token") String token) {
        return ashwinshethQhseService.findOBSByFilter(fromDate, toDate, userId, token);
    }
    ...
    public ResponseEntity<Object> findSafetyStatistics(
        ...
        return ashwinshethQhseService.findSafetyStatistics(userId, token, projectId);
    }
    ...
    public ResponseEntity<Object> sendBulletin(
        ...
        return ashwinshethQhseService.sendBulletin(userId, token, bulletinRequest);
    }
    ...
    public ResponseEntity<Object> findBulletinByProjectId(
            ...
            @RequestHeader(value = "token") String token,
            @PathVariable(value = "projectId") Integer projectId) {
        return ashwinshethQhseService.findBulletinByProjectId(userId, token, projectId);
    }
    ...
    public ResponseEntity<Object> getSafetyDigitalLibrary(
        ...
        return ashwinshethQhseService.getSafetyDigitalLibrary(userId, token, projectId);
    }
    ...
    public ResponseEntity<Object> getPendingPtw(
            ...
            @RequestHeader(value = "token") String token,
            @RequestParam(value = "projectId") int projectId) {
        return ashwinshethQhseService.getPendingPtw(userId, token, projectId);
    }
    ...
    public ResponseEntity<Object> findCompanyUsers(
            @RequestHeader(value = "userId") Integer userId,
            @RequestHeader(value = "token") String token) {
        return ashwinshethQhseService.findCompanyUsers(userId, token);
    }
    ...
    public ResponseEntity<Object> getDataForObsReport(
        ...
        return ashwinshethQhseService.getDataForObsReport(userId, token, obsId, webCall);
    }
    ...
    {
        return ashwinshethQhseService.addEmergencyHelpLine(userId,token,emergencyHelplineRequest);
    }
    ...
    public ResponseEntity<List<Object>> getAllEmergencyHelpLine(@RequestHeader(value = "userId") Integer userId,
                                                                ...
                                                                int projectId)
    {
        return ashwinshethQhseService.getAllEmergencyHelpLine(userId,token,projectId);
    }
    ...
    public ResponseEntity<Object> updateEmergencyHelpLine(@RequestHeader(value = "userId") Integer userId,
                                                          ...
                                                          @RequestBody Object emergencyHelplineRequest)
    {
        return ashwinshethQhseService.updateEmergencyHelpLine(userId,token,emergencyHelplineRequest);
    }
    ...
    {
        return ashwinshethQhseService.deleteEmergencyHelpLine(userId,token,id);
    }
    ...
    public ResponseEntity<Object> uploadHazards(@RequestHeader(value = "userId") Integer userId,
                                                ...
                                                @RequestParam(value = "file") MultipartFile file)
    {
        return ashwinshethQhseService.uploadHazards(userId,token,projectId,file);
    }
    ...
    {
        return ashwinshethQhseService.getHazardsByProjectId(userId,token,projectId);
    }
    ...
    public ResponseEntity<Map<String, Object>> findLocation(@RequestBody String data,
                                                            @RequestParam(value = "lastSync", required = false) String lastSync)
    {
        return ashwinshethQhseService.findLocation(data,lastSync);
    }
    ...
    {
        return ashwinshethQhseService.getLocationLevel1ByProjectId(projectId);
    }
    ...
    public String addLocations(@RequestParam(value = "userId") int userId,
                               ...
                               @RequestParam(value = "projectId") int projectId)
    {
        return ashwinshethQhseService.addLocations(userId,file,projectId);
    }
    ...
    public Map<String, Integer> checklistDataUpload(
            ...
            @RequestParam(value = "userId") int userId)
    {
        return ashwinshethQhseService.checklistDataUpload(file,userId);
    }
    ...
    {
        return ashwinshethQhseService.getRelatedLocation(user_id, token, relatedLocationRequest);
    }
    ...
    {
        return ashwinshethQhseService.saveProgressReport(userId,token,progressReportRequest);
    }
    ...
    {
        return ashwinshethQhseService.getProgressReport(userId,token);
    }
    ...
    {
        return ashwinshethQhseService.getProgressReportById(userId,token,progressReportId);
    }
    ...
    {
        return ashwinshethQhseService.restProjects(user_id,token,lastSync);
    }
    ...
    {
        return ashwinshethQhseService.addProject(userId,token,projectCreateRequest);
    }
    ...
    {
        return ashwinshethQhseService.updateProject(userId,token,projectUpdateRequest);
    }
    ...
    public List<Object> getProjects(@RequestHeader("userId") int userId,
                                    @RequestHeader("token") String token)
    {
        return ashwinshethQhseService.getProjects(userId,token);
    }
    ...
    public ResponseEntity<Resource> downloadUsersExcel(
            ...
            @RequestParam(value = "pageSize",   defaultValue = "1000") int pageSize)
    {
        return ashwinshethQhseService.downloadProjects(userId, token, pageNum, pageSize);
    }
    ...
    {
        return ashwinshethQhseService.getObsFilter(userId,token,filterCrfiRequest);
    }
    ...
    public ResponseEntity<Object> createQCObservation(@RequestHeader(value = "userId") Integer userId,
                                                      ...
                                                      @RequestBody Object obsRequest)
    {
        return ashwinshethQhseService.createQCObservation(userId,token,obsRequest);
    }
    ...
    public ResponseEntity<List<Object>> getObs(@RequestHeader(value = "userId") int userId,
                                               ...
                                               @RequestParam(value = "projectId") long projectId)
    {
        return ashwinshethQhseService.getObs(userId,token,obsId,projectId);
    }
    ...
    {
        return ashwinshethQhseService.updateOBS(userId,token,obsUpdateRequest);
    }
    ...
    public ResponseEntity<Object> getOBSDetails(@RequestHeader(value = "userId") int userId,
                                                ...
                                                @RequestParam(value = "obsId") long obsId)
    {
        return ashwinshethQhseService.getOBSDetails(userId,token,obsId);
    }
    ...
    public ResponseEntity<Object> getDataForQCObsReport(@RequestParam(value = "user_id") int userId,
                                                        ...
                                                        @RequestParam(value = "webCall", defaultValue = "false", required = false) boolean webCall)
    {
        return ashwinshethQhseService.getDataForQCObsReport(userId, token, obsId, webCall);
    }

    @RequestMapping(value = "/qcStages", method = RequestMethod.GET)
    public ResponseEntity<Map<String, Object>> getAll()
    {
        return ashwinshethQhseService.getAll();
    }
    ...
    {
        return ashwinshethQhseService.create(stageName);
    }
    ...
    {
        return ashwinshethQhseService.ptwReportDownload(userId,token,ptwId,webCall);
    }
    ...
    {
        return ashwinshethQhseService.safetyObsReportByFilter(fromDate,toDate,userId,projectId);
    }
    ...
    {
        return ashwinshethQhseService.downloadMemoPdf(user_id,token,obsId);
    }
    ...
    {
        return ashwinshethQhseService.downloadDebitPdf(user_id,token,debitId);
    }
    ...
    {
        return ashwinshethQhseService.downloadIncidentPdf(user_id,token,incidentId);
    }
    ...
    {
        return ashwinshethQhseService.downloadSnagingPdf(user_id,token,filterRequest);
    }
    ...
    public ResponseEntity<Object> sendIncidentPdf(@RequestHeader("user_id") int user_id,
                                                  ...
                                                  @RequestParam(name = "incidentId", required = false, defaultValue = "0") int incidentId)
    {
        return ashwinshethQhseService.sendIncidentPdf(user_id,token,incidentId);
    }
    ...
    {
        return ashwinshethQhseService.downloadTBTPdf(user_id,token,tbtId);
    }
    ...
    {
        return ashwinshethQhseService.equipmentReport(equipmentReportRequest);
    }
    ...
    {
        return ashwinshethQhseService.getObsReport(userId,token,obsId);
    }
    ...
    {
        ashwinshethQhseService.weeklyStatusReport(projectId,fromDate,toDate,locationBased);
    }
    ...
    public ResponseEntity<Object> downloadWorkerPdf(@RequestParam("user_id") int user_id,
                                                    ...
                                                    @RequestParam(value = "webCall", defaultValue = "true", required = false) boolean webCall)
    {
        return ashwinshethQhseService.downloadWorkerPdf(user_id,token,workerId,webCall);
    }
    ...
    public ResponseEntity<Object> saveIncident(@RequestHeader(value = "userId") Integer userId,
                                               ...
                                               @RequestBody Object request)
    {
        return ashwinshethQhseService.saveIncident(userId,token,request);
    }
    ...
    {
        return ashwinshethQhseService.findIncidentById(userId,token,incidentId);
    }
    ...
    {
        return ashwinshethQhseService.saveSafetyWorkers(userId,token,safetyWorkersRequest);
    }
    ...
    {
        return ashwinshethQhseService.getSafetyWorkers(userId,token,projectId);
    }
    ...
    {
        return ashwinshethQhseService.getSafetyWorkersById(userId,token,workerId);
    }
    ...
    public ResponseEntity<Object> updateSafetyWorkerById(@RequestHeader(value = "user_id") int userId,
                                                         ...
                                                         @RequestBody Object request)
    {
        return ashwinshethQhseService.updateSafetyWorkerById(userId,token,workerId,request);
    }
    ...
    public ResponseEntity<List<Object>> getAllUnitMaster(@RequestHeader(value = "userId") Integer userId,
                                                         @RequestHeader(value = "token") String token)
    {
        return ashwinshethQhseService.getAllUnitMaster(userId,token);
    }
    ...
    {
        return ashwinshethQhseService.getUnitMasterById(userId,token,unitMasterId);
    }
    ...
    {
        return ashwinshethQhseService.createSnag(userId, token, snagRequest);
    }
    ...
    public ResponseEntity<List<Object>> getSnag(@RequestHeader(value = "userId") int userId,
                                                ...
                                                @RequestParam(value = "projectId") long projectId)
    {
        return ashwinshethQhseService.getSnag(userId, token, snagId, projectId);
    }
    ...
    {
        return ashwinshethQhseService.getSnagFilter(userId, token, filterObsRequest);
    }
    ...
    public ResponseEntity<Object> updateSnag(@RequestHeader(value = "userId") int userId,
                                             @RequestHeader(value = "token") String token,
                                             @RequestBody Object obsUpdateRequest){
        return ashwinshethQhseService.updateSnag(userId, token, obsUpdateRequest);
    }
    ...
    public ResponseEntity<Object> getSnagDetails(@RequestHeader(value = "userId") int userId,
        ...
        return ashwinshethQhseService.getSnagDetails(userId, token, obsId);
    }
    ...
    public ResponseEntity<Object> getDataForSnagReport(@RequestParam(value = "user_id") int userId,
                                                       ...
                                                       @RequestParam(value = "webCall", defaultValue = "false", required = false) boolean webCall)
    {
        return ashwinshethQhseService.getDataForSnagReport(userId, token, snagId, webCall);
    }
    ...
    {
        return ashwinshethQhseService.addUser(userId,token,userRequestModel);
    }
    ...
    public ResponseEntity<Object> UpdateUser(@RequestHeader(value = "userId") Integer userId,
                                             ...
                                             @RequestBody Object userRequestModel)
    {
        return ashwinshethQhseService.UpdateUser(userId,token,userRequestModel);
    }
    ...
    public ResponseEntity<List<Object>> getUsers(@RequestHeader(value = "userId") Integer userId,
                                                 ...
                                                 @RequestParam(value = "pageSize", defaultValue = "1000") int pageSize)
    {
        return ashwinshethQhseService.getUsers(userId,token,projectId,companyId,pageNum,pageSize);
    }
    ...
    public ResponseEntity<Object> filterUsers(
            ...
            @RequestHeader(value = "token")  String  token,
            @RequestBody Object filterRequest){
        return ashwinshethQhseService.filterUsers(userId, token, filterRequest);
    }
    ...
    {
        return ashwinshethQhseService.getNonProjectUsers(projectId,companyId);
    }
    ...
    {
        return ashwinshethQhseService.userMapping(userMappingRequest);
    }
    ...
    {
        return ashwinshethQhseService.deleteUser(userId);
    }
    ...
    {
        return ashwinshethQhseService.updateUserStatus(userId, active);
    }
