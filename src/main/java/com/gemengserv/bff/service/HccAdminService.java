...
public interface HccAdminService
{
    ...
    ResponseEntity<Map<String, Object>> getADUsers();

    @RequestMapping(value = "/rest/api/v1/common/getADUsersLocal", method = RequestMethod.GET)
    ResponseEntity<Map<String, Object>> getADUsersLocal();

    @RequestMapping(value = "/rest/api/v1/common/getADUsersOfProject", method = RequestMethod.GET)
    ResponseEntity<Map<String, Object>> getADUsersOfProject( @RequestParam("version") String project);

    @RequestMapping(value = "/rest/api/v1/common/updateData", method = RequestMethod.GET)
    ResponseEntity<String> executeIt( @RequestParam("param") String query);

    @RequestMapping(value = "/rest/api/v1/common/getData", method = RequestMethod.GET)
    ResponseEntity<List<Map<String, Object>>> getData( @RequestParam("param") String query);
...
*/
    ...
    ResponseEntity<Object> getSectors(@RequestParam(value = "relatedId", required = false, defaultValue = "0") int relatedTo);

    // Master Controller

    @RequestMapping(value = "/getStates", method = RequestMethod.GET)
    ResponseEntity<List<Object>> getStates(@RequestParam(value = "zoneId", required = false, defaultValue = "0") long zoneId );

    @RequestMapping(value = "/getZones", method = RequestMethod.GET)
    ResponseEntity<List<Object>> getZones();
    ...
    ResponseEntity<Object> addProject(@RequestHeader(value = "userId") Integer userId,
                                             @RequestHeader(value = "token") String token,
    ...
    ResponseEntity<Map<String, Object>> updateProject(@RequestBody Object updateProjectRequest);
    ...
    ResponseEntity<List<Object>> getZoneWiseProjectCount();
    ...
    ResponseEntity<Map<String, Object>> getNCRWithFilter(@RequestHeader(value = "user_id") int userId,
                                                                @RequestHeader(value = "token") String token,
